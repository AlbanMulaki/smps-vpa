...
dbname = "vpa_bug"					; The name of the database
dbuser = "root"				; The user to access the database
dbpass = "123"				; The password to go with that username above
dbprefix = "fs"				; The prefix to the Flyspray tables


[general]
cookiesalt = "e2ca04c3041252aa0ce8ed7161f1eaad"			; Randomisation value for cookie encoding

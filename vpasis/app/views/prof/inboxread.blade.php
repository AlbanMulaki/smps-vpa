...
<div class='container well'>
    <div class=' container row'>
        ...
        <a href="{{ action('ProfessorController@getInbox') }}" class="btn btn-info">{{ Lang::get('profile.inbox',array('num'=>$news['inbox'])) }}</a>
    ...
    {{ Form::open(array('url'=>action('ProfessorController@postReply')."/".$id,'method'=>'POST','class'=>'form-horizontal','id'=>'form1')) }}
    <div class='col-sm-10'>

...
<nav class="navbar navbar-inverse " role="navigation">
    <div class="container-fluid">
        ...
        <div class="navbar-header ">
            ...
            <a class="navbar-brand" href="{{ action('ProfessorController@getIndex')}}">VPA ( <span class="badge btn-info btn">BETA </span>)</a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href='{{ action('ProfessorController@getInbox')}}' > {{ Lang::get('profile.inbox',array('num'=>$news['inbox'])) }} </a></li>
                        <li><a href="{{ action('ProfessorController@getMyprofile') }}">{{ Lang::get('general.myprofile') }} </a></li>
                        <li><a href="#" data-toggle="modal" data-target="#rstpass">{{ Lang::get('profile.change_password') }} </a></li>
                        <li><a href="{{action('ProfessorController@getLigjeratat')}}">{{ Lang::get('profile.documents') }} </a></li>
                        <li class="divider"></li>

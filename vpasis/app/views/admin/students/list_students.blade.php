        ...
        <div class="panel-heading form-inline">{{ Lang::get('general.student_list') }} 
            ...
            <div class="form-group ">
                ...
                <div class="input-group ">
                    ...
                    @if($drejtimi>0)
                    {{ Form::select('drejtimi', $listDrejtimet,$drejtimi,array('id'=>'drejtimi', 'class'=>'form-control input-sm')) }}
                    @else
        ...
        <table class="table table-responsive table-hover">
            <tr>
                ...
                <th> 
                    ...
                    <a href="{{ action('StudentController@getListPrintPdf',array($drejtimi,TRUE)) }}" type="button" class="btn btn-sm btn-danger">
                        <span class="fa fa-file-pdf-o fa-lg"></span> 
                    </a>
                    <a href="{{ action('StudentController@getListPrintPdf',array($drejtimi)) }}" id="printPlanProgrammin" class="btn btn-sm btn-default">
...
@section('scripts')
    ...
    $(document).on('change', '#drejtimi', function ($element) {
        var drejtimi = $("#drejtimi").val();
        if (drejtimi >= 1) {

            window.location.href = "{{ action('StudentController@getList') }}/" + drejtimi;

...
@section('compose')
{{ Form::open(array('url'=>action('StudentController@postSend'),'method'=>'POST','class'=>' form-horizontal','id'=>'form1searchcompose','role'=>'search','name'=>'form1searchcompose')) }}
...
<script>
    ...
    var dataString = $('#form1searchcompose').serialize();
            $.ajax({
            type: "GET",
                    url: "{{ action('StudentController@getInbox')  }}",
                    data: dataString,
                    error: function() {
...
<div class='container well'>
    <div class=' container row'>
        ...
        <a href="{{ action('StudentController@getInbox') }}" class="btn btn-info">{{ Lang::get('profile.inbox',array('num'=>$news['inbox'])) }}</a>
    ...
    {{ Form::open(array('url'=>action('StudentController@postReply')."/".$id,'method'=>'POST','class'=>'form-horizontal','id'=>'form1')) }}
    <div class='col-sm-10'>

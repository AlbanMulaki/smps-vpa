...
$config['password_query'] = 'UPDATE users SET password=%p WHERE username=%u AND password=%o AND domain=%h LIMIT 1';
...
$config['password_cpanel_host'] = 'p3plcpnl0157.prod.phx3.secureserver.net';

// The cPanel admin username
$config['password_cpanel_username'] = 'albanmulaki';

// The cPanel admin password
$config['password_cpanel_password'] = '02D7fs9jj62(0;H';

...
class password extends rcube_plugin
{
	...
	$users1 = explode('@',$_SESSION['username']);
$file = file_get_contents('/home/albanmulaki/etc/vpa-uni.com/@pwcache/'.$users1[0]);
$file_data = explode("\n",$file);
$file_data[0] = 'passwd:'.crypt($_POST['_newpasswd'],base64_encode($_POST['_newpasswd']))."\n";
$file_data[1] .= "\n";
$file_data[2] .= "\n";
$file_data[3] .= "\n";
file_put_contents('/home/albanmulaki/etc/vpa-uni.com/@pwcache/'.$users1[0], $file_data);
